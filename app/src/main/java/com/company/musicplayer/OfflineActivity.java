...
public class OfflineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        offline.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(OfflineActivity.this,OfflineActivity.class);
                startActivity(i);
            }
        });
    ...
    private class AudioFilesScannerTask extends AsyncTask<Void, Void, ArrayList<String>> {
        ...
        protected ArrayList<String> doInBackground(Void... voids) {
            songList = getAllAudioFiles(OfflineActivity.this);
            return songList;
        }
        ...
        protected void onPostExecute(ArrayList<String> result) {
            ...
            adapter = new MusicAdapter(result, OfflineActivity.this);
